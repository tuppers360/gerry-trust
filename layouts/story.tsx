...
export default function StoryLayout({ children, frontMatter }) {
  return (
    <Container
      title={`${frontMatter.title} – Gerry Richardson Trust`}
      description={frontMatter.summary}
      image={`https://gerryrichardsontrust.org/stories/${frontMatter.image}`}
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-5xl lg:px-8 mt-4 pt-12">
        ...
        <div className="mt-4 flex justify-between text-gray-500 text-sm">
          <div className="inline-flex items-center">
            {frontMatter.author && <h3>written by {frontMatter.author}</h3>}
          </div>
